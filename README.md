...
[![Javadocs](http://javadoc.io/badge/org.zouzias/spark-lucenerdd_2.11:0.2.7.svg?color=yellowgreen)](http://javadoc.io/doc/org.zouzias/spark-lucenerdd_2.11/)
...
```
libraryDependencies += "org.zouzias" %% "spark-lucenerdd" % "0.2.7"
```
...
```
$ bin/spark-shell --packages org.zouzias:spark-lucenerdd_2.11:0.2.7
```
...
------------------------- | ------------ | -------------------------- | ----- | ----
0.2.8-SNAPSHOT            |             | >= 2.1.0           | [develop](https://github.com/zouzias/spark-lucenerdd/tree/develop) | Under Development
0.2.7 | 2017-03-02   | >= 2.1.0           | [tag v0.2.7](https://github.com/zouzias/spark-lucenerdd/tree/v0.2.7) | Released 
