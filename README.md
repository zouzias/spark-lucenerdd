...
`LuceneRDD`'s responsibility is to collect and aggregate the search results from the executors to the driver. Currently, the following queries are supported:
