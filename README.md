...
[![Javadocs](http://javadoc.io/badge/org.zouzias/spark-lucenerdd_2.11:0.3.3.svg?color=yellowgreen)](http://javadoc.io/doc/org.zouzias/spark-lucenerdd_2.11/)
...
```
libraryDependencies += "org.zouzias" %% "spark-lucenerdd" % "0.3.3"
```
...
```
$ bin/spark-shell --packages org.zouzias:spark-lucenerdd_2.11:0.3.3
```
...
------------------------- | --------------- | -------------------------- | ----- | ----
0.3.4-SNAPSHOT            |                 | >= 2.3.1, >=JVM 8  | [develop](https://github.com/zouzias/spark-lucenerdd/tree/develop) | Under Development
0.3.3                     |  2018-07-21     | >= 2.3.1, >=JVM 8  | [tag v0.3.3](https://github.com/zouzias/spark-lucenerdd/tree/v0.3.3) | Released
