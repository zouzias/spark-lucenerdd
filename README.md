...
[![Javadocs](http://javadoc.io/badge/org.zouzias/spark-lucenerdd_2.11:0.3.2.svg?color=yellowgreen)](http://javadoc.io/doc/org.zouzias/spark-lucenerdd_2.11/)
...
```
libraryDependencies += "org.zouzias" %% "spark-lucenerdd" % "0.3.2"
```
...
```
$ bin/spark-shell --packages org.zouzias:spark-lucenerdd_2.11:0.3.2
```
...
------------------------- | --------------- | -------------------------- | ----- | ----
0.3.3-SNAPSHOT            |                 | >= 2.3.0, >=JVM 8  | [develop](https://github.com/zouzias/spark-lucenerdd/tree/develop) | Under Development
0.3.2                     |  2018-04-18     | >= 2.2.1, >=JVM 8  | [tagv0.3.2](https://github.com/zouzias/spark-lucenerdd/tree/v0.3.2) | Released
